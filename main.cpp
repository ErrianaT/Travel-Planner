...
int main() {
    ...
    sf::Text week = createText(regular, "Week: ", 23, sf::Color::White, 395, 230 );
    ...
    sf::Text precipitation = createText(regular, "Average Temp: ", 23, sf::Color::White, 120, 530);
    sf::Text windspeed = createText(regular, "Precipitation: ", 23, sf::Color::White, 120, 565);
    sf::Text temp = createText(regular, "Wind Speed: ", 23, sf::Color::White, 120, 595);
    ...
    while(welcomewindow.isOpen()){
        ...
        welcomewindow.draw(month); welcomewindow.draw(week);
